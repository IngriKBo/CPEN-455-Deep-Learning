...
def get_label(model, model_input, device):
    ...
    with torch.no_grad():
        ...
        # stack across all classes → shape (NUM_CLASSES, batch_size)
        log_likelihoods = torch.cat(log_likelihoods, dim=0)

        # choose the class with highest log-likelihood
...
if __name__ == '__main__':
    ...
    model = PixelCNN(nr_resnet=5, nr_filters=100, input_channels=3, nr_logistic_mix=10, num_classes=NUM_CLASSES)
    #End of your code
